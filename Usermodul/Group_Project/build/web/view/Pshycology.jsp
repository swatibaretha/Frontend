<%-- 
    Document   : Pshycology
    Created on : Nov 28, 2023, 12:05:17 AM
    Author     : Lenovo
--%>
...
<body>
    ...
    <div class="container my-5  w-75">
        <div class="row row-cols-lg-1 row-cols-1">
            <div class="col w-100">
                <h2 class="fw-bold">Psychology</h2>
                <p class="fs-5">Psychology is the study of the human mind, and is the basis for many forms of mental health treatment, particularly psychotherapy. Psychology plays a role in our behaviors, emotions, relationships, personality, and much more.

                    Explore the various types of psychology, their history and the major theorists behind them, and apply this knowledge to your own mental and emotional well-being.   </div>
        </div>
    </div>
    <div class="gi py-5">
        <div class="container-fluid">
            <div class="row  row-cols-lg-2 row-cols-md-2 row-cols-sm-1">
                ...
                <div class="card">
                    <a href="Brain_1.jsp" class="cap text-decoration-none">
                        <img class="img-fluid p-3" src="https://www.verywellmind.com/thmb/rM6T6Xzf4OwTbgtfun-bAuA-YXQ=/550x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Primary-Image-tried-and-tested-betterhelp-online-therapy-review-7497949-cc42dd7ad7d943a4aa07b78491718eab.jpg" alt="">
                            <div class="card-body">
                               
                                <h4 class="card-title fw-bold">What Are the Big 5 Personality Traits?</h4>
                ...
                <div class="card">
                    <a href="Brain_2.jsp" class="cap text-decoration-none">    
                        <img class="img-fluid p-3" src="https://www.verywellmind.com/thmb/5EHt4CWvxFEfLN02a8dedr4G67E=/550x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GettyImages-1028458142-212b9d6eaf8a47318768129c4ac47746.jpg" alt="">
                            <div class="card-body">
                                <!-- <p class="card-text text-secondary fs-5">HEALTHY OAT RECIPES</p> -->
                                <h4 class="card-title fw-bold">Understanding Erikson's Stages of Psychosocial Development</h4>
