<%-- 
    Document   : index9
    Created on : Nov 27, 2023, 11:27:57 PM
    Author     : Lenovo
--%>
...
<body>
    ...
    <div id="main">
         <div id="main-content">
            <h1>Air-Fryer Cauliflower Gnocchi with Marinara Dipping Sauce</h1>            
            <br><br>
            ...
            <br>
            <ul>
                <li>2 (10 ounce) packages frozen cauliflower gnocchi, thawed, divided</li>
                <br>
                ...
                <br>
                <li>1 cup reduced-sodium marinara sauce, warmed</li>
            </ul>
            <br><br>
            <h1>Directions</h1>
            <br>
            <h3>Step 1</h3>
            <br>
            <p>Preheat air fryer to 375 degrees F. Toss 1 package gnocchi, 1 1/2 tablespoons oil and 2 tablespoons Parmesan together in a large bowl.</p>
            <br>
            <h3>Step 2</h3>
            <br>
            <p>Coat the basket of the air fryer with cooking spray. Transfer the gnocchi mixture to the basket; cook for 5 minutes, turning once halfway through. Transfer to a large bowl. Repeat the procedure with the remaining gnocchi and oil and 2 tablespoons Parmesan. Sprinkle the cooked gnocchi with parsley and the remaining 1/4 cup Parmesan. Serve with marinara.</p>
            <br><br>
            <img src="images/k64mpo6y.png" alt="">
            <br><br>
            <h2>Tips</h2>
            <br>
            <p>[][ServingSize] 1/2 cup</p>
        </div>
    </div>
