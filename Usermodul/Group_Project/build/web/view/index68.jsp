<%-- 
    Document   : index68
    Created on : Nov 27, 2023, 11:41:25 PM
    Author     : Lenovo
--%>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">
                Spinach & Mushroom Tortellini Bake</h2>
                

            <p class="fs-5 mt-4">This cheesy tortellini bake is a dish the whole family will love--it's filled with sweet-tasting marinara, mushrooms and spinach and topped with melted cheese. Complete the meal, plus get in another vegetable serving, by adding a side of broccoli or a small green salad.</p>
            <br>
            <img src="xiy093md.png" alt="">
            <br>
                ...
                <h2 class="fw-bold mt-4">
                    Ingredients</h2>
                                            ...
                                            <ul>
                                                <li>Cooking spray</li>
                                                <li>1 (20 ounce) package refrigerated three-cheese tortellini</li>
                                                <li>1 tablespoon olive oil</li>
                                                <li>12 ounces sliced fresh button mushrooms</li>
                                                <li>5 medium garlic cloves, minced</li>
                                                <li>1 (5 ounce) package fresh spinach</li>
                                                <li>2 ½ cups lower-sodium marinara sauce</li>
                                                <li>4 ounces pre-shredded low-moisture part-skim mozzarella cheese</li>
                                            </ul>
                                            <br>
                                            <h2 class="fw-bold mt-4">
                                                Directions</h2>
                                            ...
                                            <h5 class="fw-bold mt-4">
                                                step 1</h5>    
                                            <p class="fs-5 mt-4">Preheat oven to 400 degrees F. Coat an 11- x 7-inch baking dish with cooking spray. Prepare pasta according to package directions; drain.</p>
                                            <h5 class="fw-bold mt-4">
                                                step 2</h5>
                                            <p class="fs-5 mt-4">Heat oil in a large skillet over medium-high. Add mushrooms; cook, stirring often, until lightly browned, 5 to 6 minutes. Add garlic; cook, stirring occasionally, until mushrooms are soft, 3 to 4 minutes. Add spinach; cook, stirring constantly, until wilted and liquid evaporates, 4 to 5 minutes. Remove from heat.</p>        
                                            <h5 class="fw-bold mt-4">
                                                step 3</h5>  
                                            <p class="fs-5 mt-4">Stir together pasta, mushroom mixture and marinara in a large bowl. Spoon mixture evenly into prepared baking dish; sprinkle evenly with cheese. Bake in preheated oven until cheese is bubbly and lightly browned, 25 to 30 minutes.</p>    
