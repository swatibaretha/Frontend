<%-- 
    Document   : index40
    Created on : Nov 27, 2023, 11:35:12 PM
    Author     : Lenovo
--%>
...
<head>
    ...
    <style>
        *{
        ...
        .comp.mntl-taxonomysc-header__top_1-0 {
        ...
        /* Styling the heading */
        .comp.mntl-taxonomysc-heading {
            font-size: 24px;
            margin: 0;
        }

        /* Styling the breadcrumbs container */
        .comp.breadcrumbs__scroll-wrapper {
            margin: 10px 0;
        }

        /* Styling the breadcrumb items */
        .comp.mntl-breadcrumbs__item {
        ...
        /* Styling the text inside the block */
...
<body>
    ...
    <div id="main">
         ...
         <div id="main-content">
            <div id="mntl-taxonomysc-header__top_1-0" class="comp mntl-taxonomysc-header__top mntl-block">
                <div id="mntl-taxonomysc-header-group_1-0" class="comp mntl-taxonomysc-header-group mntl-block">
                <div id="mntl-breadcrumbs_1-0" class="comp breadcrumbs__scroll-wrapper mntl-breadcrumbs breadcrumbs">
                <ul id="breadcrumbs__list_1-0" class="comp type--squirrel breadcrumbs__list mntl-breadcrumbs mntl-block" data-tracking-container="true">
                <li id="mntl-breadcrumbs__item_1-0" class="comp mntl-breadcrumbs__item mntl-block">
                <a href="" rel="nocaes" id="mntl-text-link_2-0" class=" mntl-text-link mntl-breadcrumbs__link" data-tracking-container="true"><span class="link__wrapper">Healthy Recipes</span></a><!-- end: mntl-text-link mntl-breadcrumbs__link -->
                <svg class="icon icon-chevron_right ">
                <use xmlns:xlink="" xlink:href="#icon-chevron_right"></use>
                </svg>
                ...
                <a href="" rel="nocaes" id="mntl-text-link_2-0-1" class=" mntl-text-link mntl-breadcrumbs__link" data-tracking-container="true"><span class="link__wrapper">Healthy Mealtime Recipes</span></a><!-- end: mntl-text-link mntl-breadcrumbs__link -->
                </li><!-- end: comp mntl-breadcrumbs__item mntl-block -->
                </ul><!-- end: comp type--squirrel breadcrumbs__list mntl-breadcrumbs mntl-block -->
                </div><!-- end: comp breadcrumbs__scroll-wrapper js-breadcrumbs-right-overflow mntl-breadcrumbs breadcrumbs -->
                <h1 id="mntl-taxonomysc-heading_1-0" class="comp mntl-taxonomysc-heading mntl-text-block">
                Healthy Dinner Recipes</h1><!-- end: comp mntl-taxonomysc-heading mntl-text-block -->
                </div><!-- end: comp mntl-taxonomysc-header-group mntl-block -->
                </div>
                <br>
                <div id="mntl-sc-block_1-0" class="comp mntl-sc-block mntl-sc-block-html">
                    ...
                    <a id="mntl-card-list-items_1-0" class="comp card--image-top mntl-card-list-items mntl-document-card mntl-card card card--no-image" data-doc-id="8364069" data-tax-levels="" href="https://www.eatingwell.com/pasta-al-limone-8364069" data-cta="" data-ordinal="1">
                        ...
                        <img data-src="https://www.eatingwell.com/thmb/39-nlvJ3fGHKaEUJc4H9edwW3Ss=/364x242/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/spaghetti-al-limone-3x2-8264-c456df15d036439c93440b0efd67911b.jpg" width="364" height="242" alt="a recipe photo of the Pasta Al Limone " class="card__img universal-image__image ls-is-cached lazyloaded" data-expand="300" src="https://www.eatingwell.com/thmb/39-nlvJ3fGHKaEUJc4H9edwW3Ss=/364x242/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/spaghetti-al-limone-3x2-8264-c456df15d036439c93440b0efd67911b.jpg">
                        <noscript>
                        <img
                        src="https://www.eatingwell.com/thmb/39-nlvJ3fGHKaEUJc4H9edwW3Ss=/364x242/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/spaghetti-al-limone-3x2-8264-c456df15d036439c93440b0efd67911b.jpg"
                        width="364"
                        height="242"
                        class="img--noscript card__img universal-image__image"
                        alt="a recipe photo of the Pasta Al Limone "
                        />
                        </noscript>
                        </div></div>
                        </div>
                        <div class="card__content " data-tag="Healthy Italian Pasta Recipes">
                        <div class="card__header"></div>
                        <span class="card__title"><span class="card__title-text ">20-Minute Pasta al Limone</span></span>
                        <div class="card__byline mntl-card__byline " data-byline="By Domenica Marchetti"></div>
