<%-- 
    Document   : lu9
    Created on : Nov 27, 2023, 11:52:06 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Cucumber & Roasted Red Pepper Hummus Wrap</h2>
            <p class="fs-5">This easy vegetarian wrap makes a great grab-and-go lunch for work or school. Roasted red pepper hummus adds color and a little extra flavor, but any flavor hummus will work well here. Cucumber, sprouts, salad greens or spinach all add a refreshing crunch. For a peppery kick, try using arugula.</p>
            <img class="img-fluid" src="images/L27.webp" width="50%" alt="">
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              ...
              <li>¼ cup roasted red pepper hummus</li>
              <li> 1 mini cucumber, sliced (1/2 cup)</li>
              <li>½ cup mixed salad greens, spinach or sprouts</li>
             
              
            </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Place tortilla on a clean work surface. Spread hummus on the tortilla. Top with cucumber slices and greens (or spinach or sprouts). Roll up the tortilla and cut in half to serve. </p>
