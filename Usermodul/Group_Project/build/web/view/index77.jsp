<%-- 
    Document   : index77
    Created on : Nov 27, 2023, 11:44:22 PM
    Author     : Lenovo
--%>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">
                Lentil & Root Veggie Soup</h2>
                

            <p class="fs-5 mt-4">French green lentils and black lentils hold up well to long, slow cooking without becoming mushy. Save the rinds from used-up blocks of Parmesan in a resealable plastic bag or tightly sealed container in the refrigerator. They give soup broths a rich, savory flavor.</p>
            <br>
            <img src="ifjuz8sr.png" alt="">
            <br>
                ...
                <h2 class="fw-bold mt-4">
                    Ingredients</h2>
                <ul>
                    <li>3 cups chopped peeled celeriac (celery root)</li>
                    <li>2 cups chopped parsnips</li>
                    <li>1 cup chopped carrot</li>
                    <li>1 cup frozen pearl onions</li>
                    ...
                    <li>1 cup French green lentils or black lentils, rinsed</li>
                    <li>1 sprig fresh rosemary</li>      
                    <li>1 tablespoon 1 (3 inch) rind Parmesan cheese plus 1/2 cup shredded Parmesan, divided</li>
                    <li>1 bay leaf</li>      
                    <li>1 teaspoon salt</li>  
                    <li>½ teaspoon ground pepper</li> 
                    <li>4 ounces pancetta, crisp-cooked and crumbled (Optional)</li>   
                </ul>
                <h2 class="fw-bold mt-4">
                    Directions</h2>
                ...
                <h5 class="fw-bold mt-4">
                    Step 1</h5>   
                <p class="fs-5 mt-4">Combine celeriac, parsnips, carrot, pearl onions, celery, tomatoes, garlic and herbes de Provence in a 5- to 6-quart slow cooker. Add broth, lentils, rosemary, Parmesan rind, bay leaf, salt and pepper. Cover and cook on High 4 1/2 hours or on Low for 8 hours.</p>     
                
                <h5 class="fw-bold mt-4">
                    Step 2</h5>   
                <p class="fs-5 mt-4">Remove the rosemary, Parmesan rind and bay leaf. Serve the soup topped with shredded cheese and garnished with pancetta, if desired.</p>     


               <h2 class="fw-bold mt-4">
                Tips</h2>
                <p class="fs-5 mt-4">To make ahead: Chop celeriac, parsnips, carrot, celery and tomatoes and combine with onions and minced garlic. Refrigerate for up to 1 day.</p> 
                <p class="fs-5 mt-4">Equipment: 5- to 6-quart slow cooker</p>
         </div>
    </div>
  </div>
  <div class="container my-5  w-75">
