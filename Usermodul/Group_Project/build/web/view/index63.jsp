<%-- 
    Document   : index63
    Created on : Nov 27, 2023, 11:38:03 PM
    Author     : Lenovo
--%>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <p class="fs-5 mt-4">A tomato-rich dressing boosts the flavor and lowers calories and fat in this tortellini salad (the dressing is also great on green salads or grilled fish). Roasted red peppers, artichoke hearts and sun-dried tomatoes add a good dose of vitamins A, C and fiber.</p>
            <br>
            <img src="ibmd8y48.png" alt="">
            <br>
                ...
                <h2 class="fw-bold mt-4">
                    Ingredients</h2>
                                            ...
                                            <ul>
                                                <li>1 pound fresh or frozen cheese tortellini, preferably whole-wheat</li>
                                                <li>1 cup sun-dried tomatoes, (not packed in oil)</li>
                                                <li>1 14-ounce can artichoke hearts, rinsed and quartered</li>
                                                <li>1 7-ounce jar roasted red peppers, rinsed and chopped</li>
                                                <li>1 cup cherry tomatoes, halved, or 2 ripe tomatoes, seeded and chopped</li>
                                                <li>4 scallions, coarsely chopped</li>
                                                <li>½ cup finely chopped fresh basil</li>
                                                <li>1 ounce prosciutto, trimmed and julienned (optional)</li>
                                                <li>1 (9-ounce) package refrigerated cheese tortellini (such as Buitoni)</li>
                                                <li>⅛ teaspoon kosher salt</li>
                                                <li>3 cups packed fresh spinach, roughly chopped</li>
                                                <li>2 ½ tablespoons chopped fresh basil</li>
                                                <li>⅛ 1 ounce prosciutto, trimmed and julienned (optional)</li>
                                                <li>⅛ teaspoon salt</li>
                                                <li>Freshly ground pepper, to taste</li>
                                                <li>Arugula, for serving (optional)</li>
                                                <li>2 ripe tomatoes, halved and seeded</li>
                                            ...
                                            <br>
                                                ...
                                                step 1</h5>    
                                            <p class="fs-5 mt-4">Bring a large pot of water to a boil. Cook tortellini until just tender, 8 to 12 minutes or according to package directions. Drain and rinse under cold water. Transfer to a large bowl  </p>
                                                
                                                <h5 class="fw-bold mt-4">
                                                step 2</h5>    
                                            <p class="fs-5 mt-4">Meanwhile, place sun-dried tomatoes in a small bowl and cover with more boiling water. Let stand for 30 minutes. Drain and coarsely chop. </p>
                                                
                                                <h5 class="fw-bold mt-4">
                                                step 3</h5>    
                                            <p class="fs-5 mt-4">Add the sun-dried tomatoes to the tortellini along with artichoke hearts, roasted red peppers, tomatoes, scallions, basil and prosciutto, if using. Season with salt and pepper. </p>
                                                
                                                <h5 class="fw-bold mt-4">
                                                step 4</h5>    
                                            <p class="fs-5 mt-4">To prepare Tomato Vinaigrette: Working over a bowl, rub tomato halves on the large-holed side of a box grater until only the skins remain. Discard the skins. Add vinegar, oil, oregano, garlic, salt and pepper to the tomato juice and whisk until blended.  </p>
                                                
                                                <h5 class="fw-bold mt-4">
                                                step 5</h5>    
                                            <p class="fs-5 mt-4">Add the Tomato Vinaigrette to the tortellini salad and toss. Serve the salad on a bed of arugula, if desired.  </p>
                                              
                                            <h2 class="fw-bold mt-4">
                                                Tips</h2>
                                                <p class="fs-5 mt-4">Make Ahead Tip: Cover and refrigerate Tomato Vinaigrette for up to 2 days.  </p>
