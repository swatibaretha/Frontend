<%-- 
    Document   : index64
    Created on : Nov 27, 2023, 11:38:20 PM
    Author     : Lenovo
--%>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">
                Creamy Tomato Soup with Tortellini</h2>
                

            <p class="fs-5 mt-4">If you're a fan of the classic dipping duo of toasty grilled cheese and tomato soup, then you'll want to try this combo. Cheese-filled pasta floating in an earthy tomato base gives you that same creamy and delicious mashup without all the crumbs. This family-friendly tomato tortellini soup is popular with kids, but adults will love it too, for both its flavor and less than 30 minutes of active cook time.</p>
            <br>
            <img src="8h8iupjb.png" alt="">
            <br>
                ...
                <h2 class="fw-bold mt-4">
                    Ingredients</h2>
                                            ...
                                            <ul>
                                                ...
                                                <li>1 large leek, white & light green parts only, halved lengthwise, rinsed and sliced (see Tips)</li>
                                                <li>4 cloves garlic, minced</li>
                                                <li>1 (6 ounce) can no-salt-added tomato paste</li>
                                                <li>4 cups low-sodium vegetable broth or no-chicken broth</li>
                                                <li>1 (28 ounce) can Italian plum tomatoes, drained and chopped</li>
                                                <li>2 bay leaves</li>
                                                <li>1 teaspoon crushed dried oregano (see Tips)</li>
                                                <li>1 teaspoon salt</li>
                                                <li>1 (9 ounce) package cheese tortellini, fresh or frozen</li>
                                                <li>1 tablespoon all-purpose flour</li>
                                                <li>1 ½ cups half-and-half</li>
                                                <li>½ cup chopped fresh basil or parsley</li>
                                            ...
                                            <h2 class="fw-bold mt-4">
                                                ...
                                                step 1</h5>    
                                            <p class="fs-5 mt-4">Heat oil and butter in a large pot over medium heat. Add leek and garlic. Cook, stirring often, until softened, 2 to 3 minutes. Stir in tomato paste. Cook, stirring, for 2 minutes. Add broth, tomatoes, bay leaves, oregano and salt. Bring to a boil, stirring occasionally. Reduce heat and simmer for 10 minutes. </p>
                                                
                                                <h5 class="fw-bold mt-4">
                                                step 2</h5>    
                                            <p class="fs-5 mt-4">Add tortellini. Simmer until the tortellini are tender, 4 to 7 minutes. </p>
                                               
                                                <h5 class="fw-bold mt-4">
                                                step 3</h5>    
                                            <p class="fs-5 mt-4"> Remove the bay leaves. Whisk flour and half-and-half in a small bowl. Stir the mixture into the soup. Add basil (or parsley). Cook, stirring occasionally, until slightly thickened, about 1 minute. </p>
                                                
                                            <h2 class="fw-bold mt-4">
                                                Tips</h2>
                                                <p class="fs-5 mt-4">Tips: Clean leeks well to be sure they're grit-free: After slicing, swish around in a bowl of water to release any sand or soil trapped between the layers. Scoop the leeks out of the bowl with a slotted spoon, leaving any sand or soil behind in the bowl. Drain well. Repeat as needed. </p>
                                                <p class="fs-5 mt-4">To crush dried herbs, press and rub them in your hand. This releases their aromatic, flavor-infusing oils before you cook with them.</p>
          </div>
    </div>
  </div>
  <div class="container my-5  w-75">
