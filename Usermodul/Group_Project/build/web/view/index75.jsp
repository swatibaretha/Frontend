<%-- 
    Document   : index75
    Created on : Nov 27, 2023, 11:43:48 PM
    Author     : Lenovo
--%>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">
                Tofu, Snow Pea & Carrot Wild Rice Salad</h2>
                

            <p class="fs-5 mt-4">Sesame oil and nori (dried seaweed) give this healthy grain-salad recipe Asian flair. Serve as a vegetarian main dish or as a side for grilled shrimp or baked chicken.</p>
            <br>
            <img src="pnrpnjvz.png" alt="">
            <br>
                ...
                <ul>
                    ...
                    <li>3 cups cooked and cooled wild rice (see Tips)</li>
                    <li>2 cups cubed seasoned baked tofu (8 ounces)</li>
                    <li>2 cups sliced snow peas</li>
                    <li>1 cup diced carrots</li>
                    <li>¼ cup crumbled nori</li>      
                </ul>
                <h2 class="fw-bold mt-4">
                    Directions</h2>
                ...
                <h5 class="fw-bold mt-4">
                    Step 1</h5>   
                <p class="fs-5 mt-4">Whisk oil, vinegar, shallot, salt and pepper in a large bowl. Add wild rice, tofu, snow peas and carrots; stir to combine. Serve topped with nori.</p>     
     
               <h2 class="fw-bold mt-4">
                Tips</h2>
                <p class="fs-5 mt-4">Tips: To make 3 cups cooked wild rice: Bring 1 1/4 cups wild rice and 5 cups water to a boil in a medium saucepan. Reduce heat to maintain a gentle simmer; cover with a tight-fitting lid and cook until tender, 45 to 55 minutes. Drain if needed.</p> 
         </div>
    </div>
  </div>
  <div class="container my-5  w-75">
