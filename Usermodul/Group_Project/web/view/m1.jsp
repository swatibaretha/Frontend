<%-- 
    Document   : m1
    Created on : Nov 27, 2023, 11:56:22 PM
    Author     : Lenovo
--%>
...
<body>
    ...
    <div class="container my-5  w-75">
        <div class="row row-cols-lg-1 row-cols-1">
            <div class="col w-100">
                <h2 class="fw-bold">Mindfulness and Meditation</h2>
                <p class="fs-5">There are many health benefits of meditation. Learn how to use meditation to relieve stress and tension, relax the body, find focus, and center your mind.</p>
            </div>
        </div>
    </div>
    <div class="gi py-5">
        <div class="container-fluid">
            <div class="row  row-cols-lg-2 row-cols-md-2 row-cols-sm-1">
                ...
                <div class="card">
                    <a href="m2.jsp" class="cap text-decoration-none">
                        <img class="img-fluid p-3" src="https://cdn.britannica.com/11/162611-050-E9C06663/Illustration-human-head-brain-waves.jpg" height="1000PX" width="90%" >
                            <div class="card-body">
                               
                                <h4 class="card-title fw-bold">MINDFULNESS AND MEDITATION</h4>
