<%-- 
    Document   : index65
    Created on : Nov 27, 2023, 11:38:41 PM
    Author     : Lenovo
--%>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">
                Spinach-Tortellini Soup</h2>
                

            <p class="fs-5 mt-4">When you need a quick and flavorful dinner, turn to this easy tortellini soup with spinach. Refrigerated cheese tortellini bulk up the soup and cook in just minutes. The tortellini can be delicate, so be careful when stirring the soup to avoid them falling apart.</p>
            <br>
            <img src="kx2h6hke.png" alt="">
            <br>
                ...
                <h2 class="fw-bold mt-4">
                    Ingredients</h2>
                                            ...
                                            <ul>
                                                ...
                                                <li>1 ½ cups chopped yellow onion</li>
                                                <li>1 tablespoon minced garlic</li>
                                                <li>2 teaspoons Italian seasoning</li>
                                                <li>½ teaspoon crushed red pepper</li>
                                                <li>1 tablespoon tomato paste</li>
                                                <li>½ cup dry white wine</li>
                                                <li>4 cups lower-sodium vegetable broth</li>
                                                <li>1 (15 ounce) can no-salt-added fire-roasted tomatoes, undrained</li>
                                                <li>1 (3 inch) Parmesan rind (1 ounce)</li>
                                                <li>¼ teaspoon salt</li>
                                                <li>1 tablespoon all-purpose flour</li>
                                                <li>1 (10 ounce) package refrigerated cheese tortellini</li>
                                            ...
                                            <h2 class="fw-bold mt-4">
                                                ...
                                                step 1</h5>    
                                            <p class="fs-5 mt-4">Heat oil in a large saucepan over medium heat. Stir in onion; cook, stirring occasionally, until translucent, about 4 minutes. Stir in garlic, Italian seasoning and crushed red pepper; cook, stirring constantly, until fragrant, about 1 minute. Stir in tomato paste; cook, stirring constantly, until all the vegetables are coated, about 1 minute. Pour in wine; cook, stirring once or twice, until reduced by half, about 2 minutes. Stir in broth, tomatoes, Parmesan rind and salt; bring to a boil over medium-high heat. Add tortellini; cook, stirring often, until the tortellini are tender, 3 to 5 minutes (or according to package directions). Remove from heat and add spinach; stir until wilted, about 1 minute. Remove and discard the Parmesan rind.</p>
