<%-- 
    Document   : index78
    Created on : Nov 27, 2023, 11:44:39 PM
    Author     : Lenovo
--%>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">
                Green Shakshuka with Spinach, Chard & Feta</h2>
                

            <p class="fs-5 mt-4">The inspiration for this green shakshuka recipe comes from HaBasta, a popular restaurant on the edge of Carmel Market in Tel Aviv, where the shakshuka is packed with green chard and spinach and a little hot pepper provides just a touch of spice. Serve with pita or crusty bread to sop up the sauce for a quick dinner or for brunch.</p>
            <br>
            <img src="7se3ckdj.png" alt="">
            <br>
                ...
                <ul>
                    ...
                    <li>1 small jalapeño or serrano pepper, thinly sliced</li>
                    <li>2 medium cloves garlic, very thinly sliced</li>
                    <li>¼ teaspoon kosher salt</li>
                    <li>¼ teaspoon ground pepper</li>
                    <li>½ cup low-sodium no-chicken or chicken broth</li>
                ...
                <h5 class="fw-bold mt-4">
                    Step 2</h5>   
                <p class="fs-5 mt-4">Crack eggs over the vegetables. Cover and cook over medium-low heat until the whites are set, 3 to 5 minutes. Remove from heat and sprinkle with cheese; cover and let stand for 2 minutes before serving.</p>     
         </div>
    </div>
  </div>
  <div class="container my-5  w-75">
