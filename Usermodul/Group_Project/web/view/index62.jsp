<%-- 
    Document   : index62
    Created on : Nov 27, 2023, 11:37:37 PM
    Author     : Lenovo
--%>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">
                Sausage, Spinach & Tortellini Soup</h2>
                

            <p class="fs-5 mt-4">Full of a comforting tomato base and plenty of fresh spinach, the spicy sausage is a zingy, flavorful addition to this easy soup recipe. If you want to make the soup ahead of time, save the tortellini for shortly before serving so that it doesn't get soggy and break apart.</p>
            <br>
            <img src="sewknfxs.png" alt="">
            <br>
                ...
                <h2 class="fw-bold mt-4">
                    Ingredients</h2>
                                            ...
                                            <ul>
                                                ...
                                                <li>12 ounces hot or mild Italian turkey sausage, casings removed</li>
                                                <li>1 cup chopped yellow onion</li>
                                                <li>1 ½ cups chopped yellow onion (from 1 medium onion)</li>
                                                <li>1 tablespoon minced garlic</li>
                                                <li>¼ cup (2 ounces) dry white wine or rosé</li>
