<%-- 
    Document   : index5
    Created on : Nov 27, 2023, 11:26:20 PM
    Author     : Lenovo
--%>
    ...
    <div id="main">
         ...
         <div id="main-content">
            ...
            <ul>
                ...
                <br>
                <li>1 ½ cups low-fat milk, divided</li>
                <br>
                <li>3 tablespoons cornstarch</li>
                <br>
                <li>1 ¾ cups shredded sharp Cheddar, preferably orange</li>
                <br>
                <li>1 10-ounce can diced tomatoes with green chiles, (see Note), drained, or 1 1/4 cups drained petite-diced tomatoes</li>
                <br>
            ...
            <h3>Step 2</h3>
            <br>
            <p>Meanwhile, whisk the remaining 1/2 cup milk and cornstarch in a small bowl. Add to the pan and cook, stirring vigorously, until bubbling and thickened, 1 to 2 minutes. Reduce heat to low, add cheese and cook, stirring, until melted. Stir in drained tomatoes, lime juice, salt, chili powder and cayenne (if using). Serve warm, garnished with scallions and cilantro.</p>
            <br><br>
            <h1>Tips</h1>
            <br>
            <p>Make Ahead Tip: Cover and refrigerate for up to 3 days. Slowly reheat on the stove over medium heat or on Medium in the microwave.</p>
            <br>
            <p>Note: We like the flavor of Rotel brand diced tomatoes with green chiles the best in this dip. Choose original or mild, depending on your spice preference.</p>
        </div>
    </div>
