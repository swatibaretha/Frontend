<%-- 
    Document   : index61
    Created on : Nov 27, 2023, 11:37:11 PM
    Author     : Lenovo
--%>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">
                Tortellini Primavera</h2>
                

            <p class="fs-5 mt-4">This creamy tortellini and vegetable pasta is a real crowd-pleaser. To make it even quicker, use frozen chopped vegetables instead of fresh ones. Serve with a green salad and whole-grain baguette.</p>
            <br>
            <img src="ccxh3u3x.png" alt="">
            <br>
                    
            <p class="fs-5 mt-4">From time savings to affordability, there are benefits to using frozen vegetables. You can substitute frozen vegetables for fresh ones in this recipe. Any 1-pound bag of mixed vegetables will work. There's no need to thaw them. Add them frozen and cook as directed.</p>
              
              <h4 class="fw-bold mt-4">
                Variations to Try</h4>
                
                <p class="fs-5 mt-4">Once you master this easy recipe, you can give it your own spin. Keep the springtime theme by using asparagus or garden peas in place of the broccoli, or give it a more summertime feel by swapping out the carrots and snap peas for fresh corn and chopped green beans. Just make sure whatever vegetables you are using equals 4 cups chopped. We like fontina and Parmesan cheese which both add a more authentic flavor, but there are other cheeses you can try. Sharp Cheddar, Gruyère or even Gorgonzola would work well. For non-vegetarians, use chicken broth in the sauce and stir in cooked, shredded chicken to boost protein.</p>
                    ...
                    Ingredients</h2>
                                            ...
                                            <h2 class="fw-bold mt-4">
                                                ...
                                                step 1</h5>
                                                    ...
                                                    <p class="fs-5 mt-4">Put a large pot of water on to boil.</p>
                                                    
                                                <h5 class="fw-bold mt-4">
                                                step 2</h5>
                                                    
                                                    <p class="fs-5 mt-4">Meanwhile, whisk broth and flour in a small bowl. Heat oil in a large skillet over medium heat. Add garlic and cook, stirring, until just beginning to brown, 1 to 2 minutes. Add the broth mixture to the pan, bring to a boil and cook, stirring occasionally, until the sauce is thick enough to coat the back of a spoon, about 3 minutes. Remove from the heat and stir in cheese, tarragon (or dill or chives) and salt. </p>
                                                    
                                                <h5 class="fw-bold mt-4">
                                                step 3</h5>
                                                    
                                                    <p class="fs-5 mt-4">Add vegetables and tortellini to the boiling water; return the water to a simmer and cook until the vegetables and tortellini are tender, 3 to 5 minutes. Drain; add to the pan with the sauce and stir to coat.</p>
