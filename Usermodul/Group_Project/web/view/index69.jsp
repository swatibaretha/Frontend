<%-- 
    Document   : index69
    Created on : Nov 27, 2023, 11:41:44 PM
    Author     : Lenovo
--%>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">
                Easy Tortellini Soup</h2>
                

            <p class="fs-5 mt-4">This nourishing, vibrant soup is on the table quickly, making it the perfect weeknight meal. The broth is delicate and creamy, thanks to the Parmesan rind, while dried basil adds an herbaceous note. We call for cheese tortellini, but you can easily swap in your favorite kind.</p>
            <br>
            <img src="79fxgu38.png" alt="">
            <br>
                ...
                <h2 class="fw-bold mt-4">
                    Ingredients</h2>
                                            ...
                                            <ul>
                                                ...
                                                <li>2 small leeks, trimmed, cleaned and finely chopped</li>
                                                <li>2 tablespoons minced garlic</li>
                                                <li>½ teaspoon dried basil</li>
                                                <li>¼ teaspoon kosher salt</li>
                                                <li>¼ teaspoon ground pepper</li>
                                                <li>6 cups lower-sodium vegetable broth</li>
                                                <li>1 Parmesan cheese rind (1 ounce)</li>
                                                <li>1 (20 ounce) package refrigerated cheese tortellini</li>
                                                <li>2 cups diagonally sliced asparagus</li>
                                                <li>1 ½ cups frozen green peas</li>
                                            ...
                                            <h5 class="fw-bold mt-4">
                                                step 1</h5>    
                                            <p class="fs-5 mt-4">Heat oil in a Dutch oven over medium heat. Add onion and leeks; cook, stirring occasionally, until translucent and tender, 3 to 5 minutes. Add garlic; cook, stirring often, until fragrant, about 1 minute. Stir in basil, salt and pepper.</p>
                                            <h5 class="fw-bold mt-4">
                                                step 2</h5>
                                            <p class="fs-5 mt-4">Add broth and Parmesan rind. Cover and bring to a boil over medium-high heat; reduce heat to medium-low to maintain a simmer. Add tortellini; cover and cook until al dente, about 4 minutes. Add asparagus and peas; cook, uncovered and stirring occasionally, until the vegetables are bright green and tender, 2 to 3 minutes. Remove and discard the Parmesan rind.</p>        
                                            <h5 class="fw-bold mt-4">
                                                step 3</h5>  
                                            <p class="fs-5 mt-4">Divide the soup among 6 bowls. Top each with 2 teaspoons Parmesan and serve with a lemon wedge.</p>    

                                            <h2 class="fw-bold mt-4">
                                                To make ahead</h2>
                                            <p class="fs-5 mt-4">Refrigerate in an airtight container for up to 5 days. Add more broth, if necessary, when reheating.</p>                                     
          </div>
    </div>
  </div>
  <div class="container my-5  w-75">
