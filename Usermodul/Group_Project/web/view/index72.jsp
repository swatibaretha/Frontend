<%-- 
    Document   : index72
    Created on : Nov 27, 2023, 11:42:23 PM
    Author     : Lenovo
--%>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">
                Roasted Vegetable & Black Bean Tacos</h2>
                

            <p class="fs-5 mt-4">These hearty vegan tacos are quick and easy to make, perfect for busy weeknights. They are so tasty no one will miss the meat or dairy.</p>
            <br>
            <img src="6sjt4s5u.png" alt="">
            <br>
                                            ...
                                            <h2 class="fw-bold mt-4">
                                                Ingredients</h2>
                                            <ul>
                                                <li>1 cup roasted root vegetables (see associated recipe)</li>
                                                <li>½ cup cooked or canned black beans, rinsed</li>
                                                ...
                                                <li>4 corn tortillas, lightly toasted or warmed</li>
                                                <li>½ avocado, cut into 8 slices</li>
                                                <li>1 lime, cut into wedges</li>
                                                <li>Chopped fresh cilantro & salsa for garnish</li>
                                            ...
                                            <h5 class="fw-bold mt-4">
                                                Step 1</h5>   
                                            <p class="fs-5 mt-4">Combine roasted root vegetables, beans, oil, cumin, chili powder, coriander, salt and pepper in a saucepan. Cover and cook over medium-low heat until heated through, 6 to 8 minutes.</p>     
                                 
                                            <h5 class="fw-bold mt-4">
                                                Step 2</h5>
                                           <p class="fs-5 mt-4">Divide the mixture among the tortillas. Top with avocado. Serve with lime wedges. Garnish with cilantro and/or salsa, if desired.</p>                                       
