<%-- 
    Document   : thise10
    Created on : Nov 28, 2023, 12:26:33 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">
                Oatmeal with Fruit & Nuts</h2>
            <p class="fs-5">This protein-packed healthy breakfast recipe gets a touch of sweetness from apple and crunch from walnuts. Feel free to pick your favorite fruit (try berries or pears) and nuts (maybe almonds or pistachios) to personalize your healthy oatmeal.
                .</p>
            <img class="img-fluid" src="https://www.eatingwell.com/thmb/yaSQXmWkDHf9X0GoQ0TXJWeXo2o=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/EWL-251317-oatmeal-with-fruit-nuts-04-A-ad4552834cec480d8c6ea92b5f29aa40.jpg" alt="">
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              ...
              <li>¼ cup chopped apple</li>
              <li>1 tablespoon walnuts, toasted if desired</li>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        ...
        <div class="col w-75 p-5" style="background-color: rgb(228,241,239);">
          ...
          <p class="fs-5"> 
            ...
            <br><br>
            People with celiac disease or gluten-sensitivity should use oats that are labeled “gluten-free,” as oats are often cross-contaminated with wheat and barley.        </div>
    </div>
  </div> 
