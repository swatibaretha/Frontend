<%-- 
    Document   : index7
    Created on : Nov 27, 2023, 11:27:19 PM
    Author     : Lenovo
--%>
    ...
    <div id="main">
         <div id="main-content">
            ...
            <ul>
                ...
                <br>
                <li>¼ cup finely chopped cooked chicken breast (about 1 1/4 oz.)</li>
                <br>
                <li>¼ cup finely shredded sharp Cheddar cheese (1 oz.)</li>
                <br>
                <li>¼ cup finely chopped scallion</li>
                <br>
                <li>2 tablespoons hot sauce (such as Frank's RedHot)</li>
                <br>
                <li>2 teaspoons chopped fresh dill</li>
                <br>
                <li>4 large jalapeño peppers, halved lengthwise (about 1 1/2 oz. each)</li>
                <br>
                <li>2 tablespoons whole-wheat panko breadcrumbs</li>
                <br>
                <li>Cooking spray</li>
            </ul>
            <br><br>
            ...
            <h3>Step 1</h3>
            <br>
            <p>Combine cream cheese, chicken, Cheddar, scallion, hot sauce and dill in a medium bowl; stir until well combined. Clean seeds and membranes from jalapeños and stuff evenly with the cream cheese mixture. Sprinkle with breadcrumbs. Place the stuffed jalapeños in the basket of an air fryer; coat with cooking spray. Cook at 370 degrees F until the tops are browned and the jalapeños are tender, about 10 minutes.</p>
            <br>
        </div>
    </div>
