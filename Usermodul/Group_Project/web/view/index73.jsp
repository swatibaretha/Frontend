<%-- 
    Document   : index73
    Created on : Nov 27, 2023, 11:43:12 PM
    Author     : Lenovo
--%>
        ...
        <div class="col w-100">
            ...
            <br>
                ...
                <ul>
                    ...
                    <li>1 ½ cups chopped green cabbage</li>
                    <li>1 ½ cups small cauliflower florets</li>
                    <li>1 cup chopped carrots</li>
                    <li>½ cup green beans, cut into 1-inch pieces</li>
                    <li>4 cups low-sodium vegetable broth</li>
                    <li>1 (14 ounce) can no-salt-added diced tomatoes</li>
                    <li>1 bay leaf</li>
                    <li>½ teaspoon salt</li>
                    <li>4 cups chopped fresh spinach</li>
                    <li>1 (15 ounce) can cannellini beans, rinsed</li>
                ...
                <h5 class="fw-bold mt-4">
                    Step 1</h5>   
                <p class="fs-5 mt-4">Place 2 tablespoons oil in a multicooker. Heat on sauté mode until hot. Add onion, bell pepper and garlic; cook, stirring often, until starting to soften, 2 to 3 minutes. Add cabbage, cauliflower, carrots and green beans and continue cooking, stirring often, until starting to soften, 4 to 6 minutes more. Add broth, tomatoes, bay leaf and salt. Turn off heat. Close and lock the lid. Cook at high pressure for 5 minutes.</p>     
        
                <h5 class="fw-bold mt-4">
                    Step 2</h5>
               <p class="fs-5 mt-4">Release the pressure. Remove bay leaf, then stir in spinach, beans and basil. Serve with a drizzle of oil, if desired.</p>                                       
