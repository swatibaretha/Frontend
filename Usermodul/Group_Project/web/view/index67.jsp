<%-- 
    Document   : index67
    Created on : Nov 27, 2023, 11:40:47 PM
    Author     : Lenovo
--%>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">
                3-Ingredient Tortellini with Sausage & Kale</h2>
                

            <p class="fs-5 mt-4">Precooked chicken sausage is a handy shortcut ingredient because it heats up quickly and adds lots of flavor without a lot of fuss. A roasted garlic variety pairs perfectly with cheese tortellini and sautéed leafy greens.</p>
            <br>
            <img src="38v4jube.png" alt="">
            <br>
                ...
                <h2 class="fw-bold mt-4">
                    Ingredients</h2>
                                            ...
                                            <ul>
                                                ...
                                                <li>1 teaspoon olive oil plus 1 tablespoon, divided</li>
                                                <li>2 precooked garlic-flavored chicken sausages, sliced</li>
                                                <li>1 (10 ounce) package chopped Tuscan kale</li>
                                                <li>⅛ teaspoon salt</li>
                                            ...
                                            <h5 class="fw-bold mt-4">
                                                step 1</h5>    
                                            <p class="fs-5 mt-4">Bring a large pot of water to a boil. Cook tortellini according to package directions; drain.</p>
                                            <h5 class="fw-bold mt-4">
                                                step 2</h5>
                                            <p class="fs-5 mt-4">Meanwhile, heat 1 teaspoon oil in a large nonstick skillet over medium heat. Add sliced sausage. Cook, stirring often, until heated through and golden brown, 2 to 4 minutes. Transfer the sausage to a plate and set aside.</p>        
                                            <h5 class="fw-bold mt-4">
                                                step 3</h5>  
                                            <p class="fs-5 mt-4">Add the remaining 1 tablespoon oil to the pan. Add kale; cooking, stirring, until wilted, 2 to 3 minutes.</p>    
                                            <h5 class="fw-bold mt-4">
                                                step 4</h5>
                                            <p class="fs-5 mt-4">Return the sausage to the pan and add the tortellini and salt. Toss to combine; season with pepper to taste.</p>    
          </div>
    </div>
  </div>
  <div class="container my-5  w-75">
