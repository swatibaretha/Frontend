<%-- 
    Document   : index76
    Created on : Nov 27, 2023, 11:44:06 PM
    Author     : Lenovo
--%>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">
                Slow-Cooker Vegan Butternut Squash Soup with Apple</h2>
                

            <p class="fs-5 mt-4">You'll never guess this crock pot butternut squash soup recipe is just dump-and-go simple. The boost of flavor from maple syrup, apple-cider vinegar and spices makes all the difference! Serve this light soup as an appetizer for a vegetarian Thanksgiving feast or with a salad and crusty bread for weeknight dinners.</p>
            <br>
            <img src="s637o1cy.png" alt="">
            <br>
                ...
                <ul>
                    ...
                    <li>4 cups no-salt-added vegetable broth</li>
                    <li>1 small butternut squash (about 2 1/2 pounds), peeled and diced</li>
                    ...
                    <li>Toasted pepitas or croutons for serving</li>      
                </ul>
                <h2 class="fw-bold mt-4">
                    Directions</h2>
                ...
                <h5 class="fw-bold mt-4">
                    Step 1</h5>   
                <p class="fs-5 mt-4">Combine onion, garlic, broth, squash, apple, oil, maple syrup, vinegar, thyme, salt, pepper, cinnamon and nutmeg in a 5- to 6-quart slow cooker. Cover and cook on Low for 8 hours or on High for 4 hours.</p>     
                
                <h5 class="fw-bold mt-4">
                    Step 2</h5>   
                <p class="fs-5 mt-4">When the time is up, remove the lid and stir well. Puree with an immersion blender or in batches in a blender. (Use caution when blending hot liquids.) Serve topped with pepitas (or croutons), if desired.</p>     


               <h2 class="fw-bold mt-4">
                Tips</h2>
                <p class="fs-5 mt-4">To make ahead: Refrigerate for up to 3 days or freeze for up to 3 months.</p> 
