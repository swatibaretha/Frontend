let app = document.querySelector("#firstdiv");
...
// end----------------------------------------------------
  ...
  for (var p of product) {
    ...
    container.style.boxShadow= "5px 5px 5px 5px";

    var image = document.createElement("img");
    image.src = `${p.thumbnail}`; // Use backticks (`) instead of single quotes
    ...
    paragraph.textContent = `${p.title}`; // Use backticks (`) instead of single quotes
    ...
    paragraph2.textContent =`${p.price}`; 
    paragraph2.style.marginTop = "10px";
    paragraph2.style.marginLeft = "120px";
